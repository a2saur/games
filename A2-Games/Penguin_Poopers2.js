...
//Getting the Canvas
const cvs = document.getElementById("penguin");
...
penguinDownImg.src = "Penguin_Down.png";

const penguinUpImg = new Image();
penguinUpImg.src = "Penguin_Up.png";

const penguinPooDownImg = new Image();
penguinPooDownImg.src = "Penguin_Poo_Down.png";

const penguinPooUpImg = new Image();
penguinPooUpImg.src = "Penguin_Poo_Up.png";

const playerImg = new Image();
playerImg.src = "Player.png";

const poopUpImg = new Image();
poopUpImg.src = "Poop_Up.png";

const poopDownImg = new Image();
poopDownImg.src = "Poop_Down.png";
